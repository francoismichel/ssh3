...
SOH already implements the common password-based and public-key (RSA and EdDSA/ed25519) authentication methods.
...
```bash
go install github.com/francoismichel/soh/cmd/...@v0.1.5-rc3
```
